...
StillateOrgano = {
  \relative c {
    ...
    f
    ges
    f4 f8. g16 f8 es d c \bar "||" %9 finis
  }
}
...
SemperFidaOrgano = {
  \relative c {
    ...
    \clef "treble_8" r \mvTr e'(-.\pE-\markup { \remarkE "assai" } -\tweak TextScript.X-offset #0 -\vlc e-. e-. d-. d-.)
    \once \slurDashed c([-. c-. h-.)] \clef bass h,(-.-\bassiE h-. h-.) %40
    c(-. c-. d-. d-. d-. d-.)
    g g e e h\f h
    c c d d d, d
    g r d'2\ff
...
SemperFidaBassFigures = \figuremode {
  ...
  <_->4 <_!>2 %65
  <_->4 <_!>2
  <9 4>16. <\t \t>32 <6>16. <\t>32 <_!>4 r16 <_!> <3>16. q32
  <9 4>16. <\t \t>32 <6>16. <\t>32 <_!>2
  r2.
  r %70
  r4. <6>
